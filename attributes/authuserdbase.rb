...
node.default['lamp']['pmwiki']['authuserdbase']['encrypt_f'] = 'md5'
node.default['lamp']['pmwiki']['authuserdbase']['email'] = 'email'
node.default['lamp']['pmwiki']['authuserdbase']['validate_code'] = 'validatecode'
